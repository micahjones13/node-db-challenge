...
1. Explain the difference between `Relational Databases` and `SQL`.
  ...
  Relational Databases are the actual database, SQL is the language used to pick out the info you want from it.

1. Why do tables need a `primary key`?

  - In order to keep track of everything in the table. Without it, some things could overlap and have the same values.
...
1. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  - Two tables to have multiple ocurences of the other table inside of it. ie, orders have lots of products, products have lots of orders. 
